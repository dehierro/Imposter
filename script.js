...
const fallbackThemePacks = [
  {
    ...
    emoji: "🏐",
    description: "Mi equipo mixto de volleyball.",
  ...
  },
  {
    ...
    title: "Club Stars",
    emoji: "⭐",
    description: "Historias y personajes del Club Stars.",
    gradient: "linear-gradient(135deg, #ffd700, #ff8c00)",
    words: [
      "Karina",
      "Los correos de Karina",
      "Los discursos de Karina",
      "Alba (Crush de Topo)",
      "Alexander",
      "Colegio Zazuar",
      "Las goteras del Zazuar",
      "Placajes",
      "Kevin",
      "Valeria",
      "Balones con huevos",
  ...
  {
    id: "volleyball",
    title: "Conceptos de Volleyball",
    emoji: "🏐",
    description: "Tecnica y tactica de la cancha.",
  ...
  },
  {
    ...
    emoji: "💍",
    description: "Viajes epicos por la Tierra Media.",
  ...
  },
  {
    ...
    title: "Harry Potter",
    emoji: "⚡",
    description: "Magia en Hogwarts y mas alla.",
